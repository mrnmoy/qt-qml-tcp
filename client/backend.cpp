...
Backend::Backend(QObject *parent) : QObject(parent) {
  ...
  connect(client->tcpSocket, SIGNAL(error(QAbstractSocket::SocketError)), this,
          SLOT(gotError(QAbstractSocket::SocketError)));
}

bool Backend::getStatus() { return client->getStatus(); }
...
void Backend::receivedSomething(QString msg) { emit someMessage(msg); }
...
void Backend::connectClicked() { client->connect2host(); }
...
void Backend::disconnectClicked() { client->closeConnection(); }
